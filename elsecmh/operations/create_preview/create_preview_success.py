...
class CreatePreviewSuccessHandler(marshalling.ElseOperation):
    """
    Handler which responds to put assets operation called by render frame operation 
    after compose operation called by create preview operation
